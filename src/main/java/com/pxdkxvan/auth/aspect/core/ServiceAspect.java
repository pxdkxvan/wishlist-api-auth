...
final class ServiceAspect extends LoggingAspect {
    ...
    private static final LoggerBuilder.Prefix BUILDER_PREFIX = LoggerBuilder.Prefix.SHAPER;
    ...
    @Around("!execution(protected * *(..)) && (@within(org.springframework.stereotype.Service) || within(com.pxdkxvan.auth.provider.*))")
